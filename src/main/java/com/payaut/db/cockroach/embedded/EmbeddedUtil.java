...
//    static final String PG_SUPERUSER = "root";
...
//    static final String LOCK_FILE_NAME = "ecrdb-lock";
    ...
    static File getWorkingDirectory() {
        final File tempWorkingDirectory = new File(System.getProperty("java.io.tmpdir"), "embedded-crdb");
        return new File(System.getProperty("ecrdb.working-dir", tempWorkingDirectory.getPath()));
    }
    ...
    static void extractTxz(InputStream stream, String targetDir) throws IOException {
        try (
            ...
            while ((entry = tarIn.getNextTarEntry()) != null) { //NOPMD
                ...
                if (individualFile.equals("cockroach") || individualFile.startsWith("./cockroach")) {

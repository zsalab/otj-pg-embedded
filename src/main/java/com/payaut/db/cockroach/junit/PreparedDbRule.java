 ...
 */
package com.payaut.db.cockroach.junit;
...
import com.payaut.db.cockroach.embedded.ConnectionInfo;
import com.payaut.db.cockroach.embedded.DatabasePreparer;
import com.payaut.db.cockroach.embedded.EmbeddedCockroach;
import com.payaut.db.cockroach.embedded.PreparedDbProvider;
...
public class PreparedDbRule extends ExternalResource {
    ...
    public PreparedDbRule customize(Consumer<EmbeddedCockroach.Builder> customizer) {
        if (dataSource != null) {

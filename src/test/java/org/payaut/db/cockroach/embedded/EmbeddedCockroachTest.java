...
public class EmbeddedCockroachTest
{
    ...
    {
        try (EmbeddedCockroach pg = EmbeddedCockroach.start();
    ...
    {
        try (EmbeddedCockroach pg = EmbeddedCockroach.builder()
    ...
    public void testValidLocaleSettingsPassthrough() throws IOException {
        try {
            EmbeddedCockroach.Builder builder = null;
            if (SystemUtils.IS_OS_WINDOWS) {
                builder = EmbeddedCockroach.builder();
